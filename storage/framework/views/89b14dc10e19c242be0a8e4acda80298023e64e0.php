...
<div class="payout-report settings-wraper">
    ...
    <div class="withdrawalOptions pb-20">
        ...
        <?php if($request == 1): ?>
            <div class="d-flex justify-content-end mt-3">
                <a href="<?php echo e(route('creator.payout.cancel', ['id' => $request_id])); ?>"
                    class="btn text-white py-2 cancel-btn">Cancel Request</a>
            </div>
        <?php else: ?>
            <?php echo $__env->make('frontend.paid_content.payout_request', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
    </div>
    <!-- Payment History -->
    <div class="payment-history">
        <div class="content-panel">
            ...
            <?php echo $__env->make('frontend.paid_content.payout_reports', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\demo\sociopro\demo_sociopro1.6\resources\views/frontend/paid_content/payouts.blade.php ENDPATH**/ ?>