        ...
        <div class="col-12">
          ...
          >
            ...
            <div class="export-btn-area">
              <a href="<?php echo e(route('admin.create.product.category')); ?>" class="export_btn" data-bs-toggle="tooltip" data-bs-placement="top"
              data-bs-custom-class="custom-tooltip"
              data-bs-title="Create Product Category"><?php echo e(get_phrase('Create')); ?></a>
            </div>
          </div>
        </div>
      </div>
                        ...
                        <td class="text-center">
                              <div class="adminTable-action me-auto">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2 eDropdown-table-action">
                                  <li><a class="dropdown-item" href="<?php echo e(route('admin.edit.product.category',$category->id)); ?>"><?php echo e(get_phrase('Edit')); ?></a></li>
                                  <li><a class="dropdown-item" onclick="return confirm('<?php echo e(get_phrase('Are You Sure Want To Delete?')); ?>')" href="<?php echo e(route('admin.delete.product.category',$category->id)); ?>"><?php echo e(get_phrase('Delete')); ?></a></li>
                                </ul>
                              </div>
                        </td>
                    </tr>
...
<?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/backend/admin/product_category/index.blade.php ENDPATH**/ ?>