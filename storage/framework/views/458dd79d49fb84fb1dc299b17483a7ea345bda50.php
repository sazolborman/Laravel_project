<div class="tab-pane fade show active" id="cProfile" role="tabpanel" aria-labelledby="cProfile-tab">
    ...
    <div class="d-flex flex-column g-30 px-30 py-30 box-shadow-5 bg-white bd-1 bd-r-5">
        <form action="<?php echo e(route('update.settings', auth()->user()->id)); ?>" enctype="multipart/form-data" method="post">
            <?php echo csrf_field(); ?>

            
            <input type="hidden" name="update" value="profile">

            <?php if($creator->config_setting == ''): ?>
            ...
            <div class="input-wrap mb-4">
                ...
                <input type="text" class="form-control eForm-control" id="eInputTitle"
                    <?php if($creator->title): ?> value="<?php echo e($creator->title); ?>"
                <?php else: ?> placeholder="Your page title" <?php endif; ?>
            ...
            <div class="input-wrap mb-4">
                ...
                <input type="text" class="form-control eForm-control" id="eInputSubTitle"
                    <?php if($creator->sub_title): ?> value="<?php echo e($creator->sub_title); ?>"
                <?php else: ?> placeholder="Your page sub title" <?php endif; ?>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap g-20">
                ...
                <div class="p-photo-right d-flex align-items-center flex-wrap g-30">
                    ...
                    <div class="userPhoto">
                        <img src="<?php echo e(asset('assets/frontend/images/' . $creator->logo)); ?>"
                            class="logo <?php if($creator->logo == ''): ?> d-none <?php endif; ?>" alt="" />
                    </div>
                    ...
                    <div class="d-flex flex-wrap g-15">
                        ...
                        <a href="<?php echo e(route('remove.photo', ['type' => 'logo'])); ?>" class="btn-delete">Delete</a>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap g-20 mt-4">
                ...
                <div class="p-photo-right d-flex flex-column align-items-end gap-3 mb-2">
                    ...
                    <div class="coverPhoto position-relative">
                        <img src="<?php echo e(asset('assets/frontend/images/' . $creator->cover_photo)); ?>" class="cover_photo w-100"
                            alt="" />
                    </div>
                    ...
                    <div class="d-flex flex-wrap g-15">
                        ...
                        <a href="<?php echo e(route('remove.photo', ['type' => 'cover_photo'])); ?>" class="btn-delete">Delete</a>
                    </div>
                </div>
            </div>
            ...
            <div class="input-wrap mb-4">
                ...
                <textarea name="description" id="eInputDescription" cols="30" rows="7" placeholder="Your page description"><?php echo e($creator->description); ?></textarea>
            </div>
            ...
            <div class="input-wrap mb-4">
                ...
                <input type="text" class="form-control eForm-control" id="eInputBio"
                    <?php if($creator->bio): ?> value="<?php echo e($creator->bio); ?>"
                <?php else: ?> placeholder="Bio" <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\resources\views/frontend/paid_content/profile_tab.blade.php ENDPATH**/ ?>