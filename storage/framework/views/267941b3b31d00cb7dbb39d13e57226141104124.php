<div class="page-wrap">
    <div class="d-flex pagetab-head  border align-items-center justify-content-between mb-3 py-2 px-3 rounded bg-white">
        <h3 class="h5 pt-3"><span><img width="12" src="<?php echo e(asset('assets/frontend/images/stickies-fill.png')); ?>" alt=""></span> <?php echo e(get_phrase('Blogs')); ?></h3>
        <div class="inline-btn w-50">
            <a href="<?php echo e(route('create.blog')); ?>" class="btn btn-primary"><i class="fa fa-plus-circle me-1"></i><?php echo e(get_phrase('Create articles')); ?></a>
        </div>
    </div>
    ...
    <div class="card blog-tags p-4">
        <div class="tags">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('category.blog',$category->id)); ?>" class="<?php if($category['id'] == $category_id): ?> active <?php endif; ?>"><?php echo e($category->name); ?></a>
    ...
    <div class="row g-3 blog-cards mt-3">
        <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4" id="blog-<?php echo e($blog->id); ?>">
                <article class="single-entry">
                    <div class="entry-img">
                        <a href="<?php echo e(route('single.blog',$blog->id)); ?>"><img src="<?php echo e(get_blog_image($blog->thumbnail,'thumbnail')); ?>" alt="" class="img-fluid"></a>
...
</div><?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/frontend/blogs/category_blog.blade.php ENDPATH**/ ?>