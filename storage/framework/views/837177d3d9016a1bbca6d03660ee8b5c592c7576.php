<div class="page-wrap">
    <div class="d-flex pagetab-head  border align-items-center justify-content-between mb-3 py-2 px-3 rounded bg-white">
        ...
        <div class="w-80">
            <a href="javascript:void(0)" onclick="showCustomModal('<?php echo e(route('load_modal_content', ['view_path' => 'frontend.video-shorts.create'])); ?>', '<?php echo e(get_phrase('Create Video & Shorts ')); ?>');" class="btn btn-primary" data-bs-toggle="modal"
                ...
                class="fa-solid fa-clapperboard me-2"></i><?php echo e(get_phrase('Create')); ?></a>
    ...
    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(DB::table('videos')->where('id', $video->video_id)->get()->count() == 0): ?>
            <?php  continue; ?>
        <?php endif; ?>
                ...
                <div class="col-md-6 col-lg-5 col-sm-12">
                    <div class="entry-thumb">
                        <video class="rounded  w-100 plyr-js" controls="" onplay="pauseOtherVideos(this)"
                            src="<?php echo e(asset('storage/videos/'.$video->getVideo->file )); ?>"></video> 
                    </div>
                </div>
                <div class="col-md-6 col-lg-7 col-sm-12">
                    <div class="entry-text ms-4">
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('video.detail.info',$video->getVideo->id )); ?>"><h3 class="h6 mt-4 mt-md-1"><?php echo e($video->getVideo->title); ?></h3> </a>
                            <div class="post-controls dropdown dotted mt-4 mt-md-1">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li>
                                        ...
                                        ?>
                                        <?php if($saved>0): ?>
                                        <a href="javascript:void(0)" onclick="ajaxAction('<?php echo route('unsave.video.later',$video->video_id); ?>')" class="dropdown-item btn btn-primary btn-sm"> <img src="<?php echo e(asset('assets/frontend/images/save.png')); ?>" alt=""> <?php echo e(get_phrase('Unsave Video')); ?></a>
                                        <?php else: ?>
                                        <a href="javascript:void(0)" onclick="ajaxAction('<?php echo route('save.video.later',$video->video_id); ?>')" class="dropdown-item btn btn-primary btn-sm"> <img src="<?php echo e(asset('assets/frontend/images/save.png')); ?>" alt=""> <?php echo e(get_phrase('Save Video')); ?></a>
                                        <?php endif; ?>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="d-flex my-2">
                            <!-- Avatar -->
                            <div class="avatar">
                                <a href="#!"><img class="avatar-img rounded-circle" src="<?php echo e(get_user_image($video->getVideo->getUser->photo,'optimized')); ?>"
                                        alt="" ></a>
                            </div>
                            <div class="avatar-info ms-2">
                                <h4 class="ava-nave"><a href="#"><?php echo e($video->getVideo->getUser->name); ?></a></h4>
                                <div class="activity-time"><?php echo e(date('M d ', strtotime($video->getVideo->created_at))); ?> at <?php echo e(date('H:i A', strtotime($video->getVideo->created_at))); ?></div>
                            </div>
                        </div>
                        <?php
                        ...
                        <div class="entry-footer">
                            <div class="footer-share pt-3 d-flex justify-content-between w-100">
                                <span class="entry-react post-react"><img src="<?php echo e(asset('assets/frontend/images/l-react.png')); ?>"
                                            alt=""> <?php echo e($user_reacts); ?>

                                </span>
                                <span class="entry-react"><?php echo e($comment); ?> <?php echo e(get_phrase('Comments')); ?></span>
                                <span class="entry-react"><?php echo e($view); ?> <?php echo e(get_phrase('Views')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/frontend/video-shorts/saved.blade.php ENDPATH**/ ?>