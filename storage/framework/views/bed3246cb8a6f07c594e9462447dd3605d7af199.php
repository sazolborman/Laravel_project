    ...
    <div class="widget">
        <div class="d-flex align-items-center">
            ...
            <?php if($current_hour >= 5 && $current_hour < 12): ?>
                <img class="img-fluid" src="<?php echo e(asset('assets/frontend/images/m-sun.png')); ?>" height="30px"
                    width="30px" alt="">
            <?php elseif($current_hour >= 12 && $current_hour < 17): ?>
                <img class="img-fluid" src="<?php echo e(asset('storage/images/cloud-sun.png')); ?>" alt="">
            <?php else: ?>
                <img class="img-fluid" src="<?php echo e(asset('assets/frontend/images/moon.png')); ?>" height="30px"
                    width="30px" alt="">
            <?php endif; ?>
        ...
        <div class="sponsors">
            ...
            <?php $__currentLoopData = $sponsorPost; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sponsor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a target="_blank" href="<?php echo e($sponsor->ext_url); ?>">
                    <div
                        class="sponsor d-flex d-md-block d-xl-flex align-items-center border mb-1 text-lg-center text-xl-start">
                        <img src="<?php echo e(get_sponsor_image($sponsor->image, 'thumbnail')); ?>"
                            class="sponsor_post_image_size ms-2 ms-lg-0 ms-xl-2 mt-2 mt-xl-0" alt="">
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\demo_sociopro1.6\resources\views/frontend/right_sidebar.blade.php ENDPATH**/ ?>