<div class="profile-wrap">
    <div class="profile-cover rounded">
        <div class="profile-header" style="background-image: url('<?php echo e(get_cover_photo($user_info->cover_photo)); ?>');">
            <button
                onclick="showCustomModal('<?php echo e(route('load_modal_content', ['view_path' => 'frontend.profile.edit_cover_photo'])); ?>', '<?php echo e(get_phrase('Update your cover photo')); ?>');"
                class="edit-cover btn"><i class="fa fa-camera"></i><?php echo e(get_phrase('Edit Cover Photo')); ?></button>
            <div class="profile-avatar d-flex align-items-center ps-4">
                ...
                <div class="avatar-details">
                    ...
                    <button
                        ...
                        class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit-profile"><i
            ...
            <div class="col-lg-7 col-sm-12">
                <nav class="profile-nav border bg-white mb-3">
                    <ul class="nav align-items-center justify-content-start">
                        ...
                        <li class="nav-item <?php if(Route::currentRouteName() == 'profile.photos'): ?> active <?php endif; ?>"><a
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\1.6\resources\views/frontend/profile/index.blade.php ENDPATH**/ ?>