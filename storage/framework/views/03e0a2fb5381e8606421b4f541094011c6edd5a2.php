<?php
    ...
    } elseif ($model == 'Sponsor' || $model == 'Subscription' || $model == 'Donation') {
...
<script>
    $(function() {
        $('#makePaymentForm').submit(function(e) {
            ...
            var key = $('#key').val();
            var key_type = "<?php echo e($key_type); ?>";
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\demo_sociopro1.6\resources\views/payment/flutterwave/index.blade.php ENDPATH**/ ?>