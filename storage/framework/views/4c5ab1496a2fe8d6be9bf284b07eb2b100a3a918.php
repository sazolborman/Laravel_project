        ...
        <div class="col-12">
          ...
          >
            <div class="d-flex flex-column">
              <h4><?php echo e(get_phrase('Edit your page information')); ?></h4>
        ...
        <div class="eSection-wrap-2">
            <div class="eForm-layouts">
              <?php if($errors->any()): ?>
                ...
                <?php endif; ?>
              <form method="POST" action="<?php echo e(route('admin.page.updated', $page_details->id)); ?>" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  <div class="mb-3">
                    <label for="title" class="form-label eForm-label"><?php echo e(get_phrase('Page title')); ?></label>
                    <input type="text" class="form-control eForm-control" value="<?php echo e($page_details->title); ?>" id="title" name="title" placeholder="Page title">
                  </div>
                  ...
                  <div class="mb-3">
                      ...
                      <select name="category" class="form-select eForm-control select2" required>
                        ...
                        <?php $__currentLoopData = DB::table('pagecategories')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($category->id); ?>" <?php if($page_details->category_id == $category->id): ?> selected <?php endif; ?>><?php echo e($category->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                  </div>
                  ...
                  <div class="mb-3">
                      ...
                      <textarea id="description" name="description" class="content"><?php echo e($page_details->description); ?></textarea>
                  </div>
...
<?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/backend/admin/page/edit.blade.php ENDPATH**/ ?>