<?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loopIndex => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($post->publisher == 'paid_content' && $post->privacy == 'friends'): ?>
    <?php endif; ?>
    <?php
                ...
                <div class="ava-info d-flex align-items-center">
                    ...
                    <div class="ava-desc ms-2">
                        <h3 class="mb-0">
                            ...
                            <?php else: ?>
                                <a class="text-black"
                                    href="<?php echo e(route('user.profile.view', $post->user_id)); ?>"><?php echo e($post->getUser->name); ?>
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\demo_sociopro1.6\resources\views/frontend/main_content/posts.blade.php ENDPATH**/ ?>