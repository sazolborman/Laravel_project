<div class="post-inner" id="tab-feeling<?php echo e($post->post_id); ?>">
    
    <div class="tag-wrap">
        <a href="javascript:void(0)" onclick="$('#tab-feeling<?php echo e($post->post_id); ?>').hide()" class="prev-btn"><i class="fa fa-long-arrow-left"></i></a>

        <div class="post-tagged mt-3">
            <div class="tag-card" id="feeling_and_activities<?php echo e($post->post_id); ?>">
            </div>
        </div>
...
</div><?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/frontend/main_content/edit_post_felling_and_activity.blade.php ENDPATH**/ ?>