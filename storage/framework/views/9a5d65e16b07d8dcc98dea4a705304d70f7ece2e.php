                            ...
                            <tr class="single-row">
                                <th scope="row">
                                    <div class="single-cell ps-md-3 d-flex align-items-center">
                                        <div class="cell-item">
                                            <p><?php echo e($subscribers->firstItem() + $key); ?></p>
                                        </div>
                                    </div>
                                </th>
                                <td>
                                    <div class="single-cell">
                                        <div class="cell-item d-flex gap-3">
                                            <div class="user_img">
                                                <img src="<?php echo e(get_user_image($subscriber->subscriber_id, 'optimized')); ?>"
                                                    height="100%">
                                            </div>
                                            <div class="user_info">
                                                <h6><?php echo e($subscriber->name); ?></h6>
                                ...
                                <td>
                                    <div class="single-cell flex-center">
                                        <div class="cell-item d-flex gap-3">
                                            <p><?php echo e($subscriber->package_title); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="single-cell flex-center">
                                        <div class="cell-item">
                                            <p><?php echo e($subscriber->package_price); ?>$</p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="single-cell d-flex justify-content-end align-items-center">
                                        <div class="cell-item">
                                            <p class="issue-date">
                                                <?php echo e(date('Y-m-d', $subscriber->issue_date)); ?></p>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\resources\views/frontend/paid_content/subscriber_list.blade.php ENDPATH**/ ?>