...
<form class="ajaxForm" action="<?php echo e(route('share.group.post')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="message-send-area">
            <button type="submit" class="btn btn-primary send"> <?php echo e(get_phrase('Share On Group')); ?> </button>
        </div>
    </div>
</form>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/frontend/main_content/my_group_list.blade.php ENDPATH**/ ?>