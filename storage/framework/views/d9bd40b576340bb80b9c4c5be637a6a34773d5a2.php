                    ...
                    <div class="header-search">
                        ...
                        <div class="sc-search">
                            <form action="<?php echo e(route('search')); ?>" method="GET">
                                <input type="search" class="rounded white-placeholder" name="search"
                    ...
                    <div class="header-controls">
                        <div class="align-items-center d-flex justify-content-around">
                            ...
                            <div class="inbox-control">
                                <a href="<?php if(!empty($last_msg)): ?> <?php echo e(route('chat', $msg_to)); ?> <?php endif; ?>"
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li>
                                        <a class="dropdown-item"
                                            href="<?php echo e(route('addons.manager')); ?>"><?php echo e(get_phrase('Addons')); ?>
...
<!-- Header End -->
<?php /**PATH C:\xampp\htdocs\demo\sociopro\demo_sociopro1.6\resources\views/frontend/header.blade.php ENDPATH**/ ?>