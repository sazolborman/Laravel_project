...
<div class="d-flex justify-content-between align-items-center">
    ...
    <form class="ajaxForm" id="chatMessageFieldForm" action="<?php echo e(route('chat.save')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="message-send-area">
            <button type="submit" class="btn btn-primary send"> <?php echo e(get_phrase('Send')); ?> </button>
        </div>
    </form>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/frontend/main_content/my_friend_list.blade.php ENDPATH**/ ?>