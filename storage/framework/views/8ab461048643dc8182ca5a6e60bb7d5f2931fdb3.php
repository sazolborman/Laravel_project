            ...
            <nav class="menu-wrap">
                <ul>
                    ...
                    <?php if(addon_status('paid_content') == 1): ?>
                        <li class="<?php if(Route::currentRouteName() == 'general.timeline' ||
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\resources\views/frontend/left_navigation.blade.php ENDPATH**/ ?>