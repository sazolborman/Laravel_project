...
<body>
    ...
    <!-- Main Start -->
    <main class="main">
        <?php echo $__env->make('frontend.marketplace.single_product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </main>
    <!-- Main End -->
...
</html><?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/frontend/marketplace/single_product_iframe.blade.php ENDPATH**/ ?>