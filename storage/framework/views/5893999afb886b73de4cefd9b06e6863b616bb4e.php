    ...
    <div class="single-item-countable single-entry" id="">
        <div class="entry-inner"> 
            <div class="entry-header d-flex justify-content-between <?php if(isset($_GET['shared'])): ?> hidden-on-shared-view <?php endif; ?>">
                <div class="ava-info d-flex align-items-center">
                    ...
                    <?php elseif(isset($type)&&$type=="group"): ?>
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(get_user_image('storage/userimage/'.$post->photo, 'optimized')); ?>" class="rounded-circle" alt="...">
                        </div>
                    <?php elseif(isset($type)&&$type=="video"): ?>
                        <div class="entry-header d-flex justify-content-between">
                            <div class="ava-info d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?php echo e(get_user_image($post->photo,'optimized')); ?>" class="rounded rounded-circle" alt="...">
                                
                                </div>
                                <div class="ava-desc ms-2">
                                    <h3 class="mb-0"><?php echo e($post->name); ?> <a href="#"><?php echo e(get_phrase('Follow')); ?></a></h3>
                            ...
                            <div class="post-controls dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="#"><img src="<?php echo e(asset('assets/frontend/images/save.png')); ?>" alt=""><?php echo e(get_phrase('Save Video')); ?></a></li>
                                    ...
                                    <li><a class="dropdown-item" href="#"><img src="<?php echo e(asset('assets/frontend/images/report.png')); ?>" alt=""><?php echo e(get_phrase('Report')); ?> </a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="ava-desc ms-2">
                        <h3 class="mb-0">
                            ...
                            <?php else: ?>
                                <a class="text-black" href="<?php echo e(route('user.profile.view',$post->user_id)); ?>"><?php echo e($post->getUser->name); ?></a>
                            <?php endif; ?>
                            <!-- Check tagged users -->
                                        ...
                                        <?php if($media_file->file_type == 'video'): ?>
                                            <?php if(File::exists('public/storage/post/videos/'.$media_file->file_name)): ?>
                                                ...
                                                <?php endif; ?>
                                                    ...
                                                    <video muted controlsList="nodownload" controls class="plyr-js w-100 rounded video-thumb <?php if($media_files_count > 1): ?> initialized <?php endif; ?>">
                ...
                <?php elseif($post->post_type == 'live_streaming'): ?>
                    <div class="row">
                        ...
                        <div class="col-12 text-center pt-5">
                            <a class="live-watch-now mt-3" href="<?php echo e(route('live', ['post_id' => $post->post_id])); ?>"><i class="fa fa-video"></i> <?php echo e(get_phrase('Watch now')); ?></a>
                        </div>
                    </div>
            ...
            <div class="entry-footer <?php if(isset($_GET['shared'])): ?> hidden-on-shared-view <?php endif; ?>">
                <div class="footer-share pt-3 d-flex justify-content-around">
                    <span class="entry-react post-react">
                        ...
                        <ul class="react-list">
                            <li><a href="javascript:void(0)" onclick="myReact('post', 'like', 'update', <?php echo e($post->post_id); ?>)"><img src="<?php echo e(asset('storage/images/r-like.png')); ?>" alt="Like"></a>
                            </li>
                            <li><a href="javascript:void(0)" onclick="myReact('post', 'love', 'update', <?php echo e($post->post_id); ?>)"><img src="<?php echo e(asset('storage/images/r-love.png')); ?>" alt="Love"></a>
                            </li>
                            <li><a href="javascript:void(0)" onclick="myReact('post', 'sad', 'update', <?php echo e($post->post_id); ?>)"><img src="<?php echo e(asset('storage/images/r-cry1.png')); ?>" alt="Sad"></a>
                            </li>
                            <li><a href="javascript:void(0)" onclick="myReact('post', 'angry', 'update', <?php echo e($post->post_id); ?>)"><img src="<?php echo e(asset('storage/images/r-angry.png')); ?>" alt="Angry"></a>
                            </li>
                        </ul>
                    </span>
...
<?php echo $__env->make('frontend.initialize', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/frontend/main_content/single-post.blade.php ENDPATH**/ ?>