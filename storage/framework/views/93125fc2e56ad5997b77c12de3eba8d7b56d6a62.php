<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li class="nav-links-li <?php if(Route::currentRouteName() == 'admin.view.category' ||
                ...
                Route::currentRouteName() == 'admin.user.edit'): ?> showMenu <?php endif; ?>">
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
        ...
        <li class="nav-links-li <?php if(Route::currentRouteName() == 'admin.view.product.category' ||
                Route::currentRouteName() == 'admin.create.product.category' ||
                Route::currentRouteName() == 'admin.view.product.brand' ||
                Route::currentRouteName() == 'admin.create.product.brand'): ?> showMenu <?php endif; ?>">
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
            ...
            <ul class="sub-menu">
                <li><a class="<?php if(Route::currentRouteName() == 'admin.view.product.category' ||
                        Route::currentRouteName() == 'admin.create.product.category'): ?> Active <?php endif; ?>"
                        href="<?php echo e(route('admin.view.product.category')); ?>"><?php echo e(get_phrase('Category')); ?></a></li>
                <li><a class="<?php if(Route::currentRouteName() == 'admin.view.product.brand' ||
                        Route::currentRouteName() == 'admin.create.product.brand'): ?> Active <?php endif; ?>"
                        href="<?php echo e(route('admin.view.product.brand')); ?>"><?php echo e(get_phrase('Brand')); ?></a></li>
            </ul>
        </li>
            ...
            <li class="nav-links-li <?php if(Route::currentRouteName() == 'author.list' ||
                ...
                <ul class="sub-menu">
                    ...
                    <li><a class="<?php if(Route::currentRouteName() == 'pending.report'): ?> Active <?php endif; ?>"
                            href="<?php echo e(route('pending.report')); ?>"><?php echo e(get_phrase('Pending report')); ?></a></li>
                </ul>
            </li>
        <?php endif; ?>
            ...
            <li class="nav-links-li <?php if(Route::currentRouteName() == 'backend.fundraiser.report' ||
                ...
                <ul class="sub-menu">
                    ...
                    <li><a class="<?php if(Route::currentRouteName() == 'backend.fundraiser.pending'): ?> Active <?php endif; ?>"
                            href="<?php echo e(route('backend.fundraiser.pending')); ?>"><?php echo e(get_phrase('Pending payout')); ?></a>
                    </li>
                </ul>
            </li>
        <?php endif; ?>
        ...
        <li class="nav-links-li <?php if(Route::currentRouteName() == 'admin.about.page.data.view' ||
            ...
            <ul class="sub-menu">
                ...
                <li><a class="<?php if(Route::currentRouteName() == 'admin.live-video.view'): ?> Active <?php endif; ?>"
                        href="<?php echo e(route('admin.live-video.view')); ?>"><?php echo e(get_phrase('Live video')); ?> </a></li>
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\1.6\resources\views/backend/admin/sidebar.blade.php ENDPATH**/ ?>