                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 text-center">
                                        ...
                                        <div class="eCard d-block text-center bg-secondary">
                                            <img src="<?php echo e(get_system_logo_favicon($system_light_logo,'light')); ?>" class="mx-4 my-5" width="200px" alt="...">
                                            <div class="eCard-body">
                                    ...
                                    <div class="col-md-3 text-center">
                                        ...
                                        <div class="eCard d-block text-center bg-light">
                                            <img src="<?php echo e(get_system_logo_favicon($system_fav_icon,'favicon')); ?>" class="mx-4 my-5" width="53px" height="60px" alt="...">
                                            <div class="eCard-body">
...
<?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/backend/admin/setting/system.blade.php ENDPATH**/ ?>