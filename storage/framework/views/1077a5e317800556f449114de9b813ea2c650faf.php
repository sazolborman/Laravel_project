        ...
        <table class="table table-borderless">
            ...
            <tbody>
                <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="single-row <?php if($report->status == 0): ?> table-light <?php endif; ?>">

                        <th scope="row">
                            <div class="single-cell ps-md-3 d-flex align-items-center">
                                <div class="cell-item">
                                    <p><?php echo e($reports->firstItem() + $key); ?></p>
                                </div>
                            </div>
                        </th>
                        <td>
                            <div class="single-cell flex-center">
                                <div class="cell-item">
                                    <p><?php echo e(date('Y-m-d', strtotime($report->issue_date))); ?></p>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="single-cell flex-center">
                                <div class="cell-item">
                                    <p><?php echo e($report->requested_amount); ?>$</p>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="single-cell flex-center">
                                <div class="cell-item">
                                    <?php if($report->status > 0): ?>
                                        <p class="issue-date">
                                            <?php echo e(date('Y-m-d', strtotime($report->received_date))); ?>
                        ...
                        <td>
                            <div class="single-cell flex-center">
                                <div class="cell-item">
                                    <?php if($report->status > 0): ?>
                                        <p><?php echo e($report->payment_method); ?></p>
                                    <?php else: ?>
                                        <span class="badge bg-danger">Pending</span>
                                    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\demo_sociopro1.6\resources\views/frontend/fundraiser/payout_report_day.blade.php ENDPATH**/ ?>