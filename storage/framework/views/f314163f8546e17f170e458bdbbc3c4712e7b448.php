<div class="paymentWrap d-flex align-items-start flex-wrap">
  <div class="paymentLeft">
    ...
    <div class="nav flex-md-column flex-row nav-pills payment_modalTab" role="tablist" aria-orientation="vertical">
      ...
      <div class="tabItem" onclick="showPaymentGatewayByAjax('<?php echo e($payment_gateway->identifier); ?>')" id="<?php echo e($payment_gateway->identifier); ?>-tab" data-bs-toggle="pill" data-bs-target="#<?php echo e($payment_gateway->identifier); ?>" role="tab" aria-controls="<?php echo e($payment_gateway->identifier); ?>" aria-selected="true">
        <div class="payment_gateway_option d-flex align-items-center">
          <div class="logo">
            <img width="100px" src="<?php echo e(get_image('assets/payment/'.$payment_gateway->identifier.'.png')); ?>" alt="" />
          </div>
          <div class="info">
      ...
      <div class="table-responsive">
        <table class="table eTable eTable-2">
          <tbody>
            ...
            <?php $total_payable_amount = 0; $counter = 0; ?>
                ...
                <td>
                  <div class="dAdmin_info_name min-w-150px text-end">
                    <?php if($item['discount_percentage'] > 0): ?>
                      <p class="text-dark"><small class="text-muted"><del><?php echo e(currency($item['price'])); ?></del></small> <?php echo e(currency($item['discount_price'])); ?></p>
                    <?php else: ?>
            ...
            <tr>
              ...
              <td>
                <div class="dAdmin_info_name min-w-150px text-end">
                  <p><span><?php echo e(get_phrase('Grand Total')); ?>: $25</span></p>
                </div>
              </td>
            </tr>
          </tbody>
...
</script><?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/payment/payment_gateway.blade.php ENDPATH**/ ?>