                            ...
                            <?php if($creator): ?>
                                ...
                                <ul class="pc-dropdown-submenu">
                                    <li class="dropdown-submenu-item <?php if(Route::currentRouteName() == 'subscriber.list'): ?> active <?php endif; ?>">
                                        <a href="<?php echo e(route('subscriber.list')); ?>">Subscribers</a>
                                    </li>
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\resources\views/frontend/addons/left_sidebar.blade.php ENDPATH**/ ?>