...
<aside class="sidebar plain-sidebar">
    <div class="widget intro-widget">
        ...
        <?php if(isset($type) && $type == 'my_account'): ?>
            <button onclick="toggleBio(this, '.edit-bio-form')"
                class="edit-bio-btn btn btn-primary w-100"><?php echo e(get_phrase('Edit Bio')); ?></button>
        <?php endif; ?>
    ...
    <div class="widget">
        ...
        <a href="<?php echo e(route('profile.photos')); ?>"
            class="btn btn-secondary mt-3 d-block mx-auto"><?php echo e(get_phrase('See More')); ?></a>
    </div>
    <!--  Widget End -->
    <div class="widget friend-widget">
        ...
        <a href="<?php echo e(route('profile.friends')); ?>"
            class="btn btn-secondary mt-3 d-block mx-auto"><?php echo e(get_phrase('See All')); ?></a
...
<!--  Sidebar End -->
<?php /**PATH C:\xampp\htdocs\demo\sociopro\1.6\resources\views/frontend/profile/profile_info.blade.php ENDPATH**/ ?>