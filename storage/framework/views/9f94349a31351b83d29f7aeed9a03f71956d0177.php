        ...
        <div class="container p-0">
            <div class="row">
                <div class="col-xl-9 order-xl-1 order-2">
                    <form action="<?php echo e(route('save.payment.settings')); ?>" method="post" class="mt-3">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\resources\views/frontend/addons/payment_settings.blade.php ENDPATH**/ ?>