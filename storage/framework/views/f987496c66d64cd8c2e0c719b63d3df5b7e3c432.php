    ...
    <div class="modal fade" id="createPost" tabindex="-1" aria-labelledby="createPostLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                    ...
                    <div class="entry-header d-flex justify-content-between">
                        <?php if(isset($page_id) && !empty($page_id)): ?>
                            ...
                            <a href="<?php echo e(route('single.page', $page_id)); ?>"
                                class="author-thumb d-flex align-items-center">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="postPrivacyDroupdownBtn">
                                    ...
                                    <li><a class="dropdown-item" href="javascript:void(0)"
                                            ...
                                            <?php if(isset($paid_content)): ?>
                                                <?php echo e(get_phrase('Subscribers')); ?>
                ...
                <textarea name="description" id="post_article"
                ...
                <div class="modal-footer text-center justify-content-center p-3">
                    ...
                    <button type="button" onclick="loadMaps('map')" data-tab="tab-location"
                        class="btn btn-secondary"><img src="<?php echo e(asset('storage/images/location.png')); ?>"
                            alt="photo"><?php echo e(get_phrase('Location')); ?></button>
                    <button type="button" class="btn btn-secondary" onclick="confirmLiveStreaming()"><img
                            src="<?php echo e(asset('storage/images/camera.svg')); ?>"
                            alt="photo"><?php echo e(get_phrase('Live Video')); ?></button>
                    <button type="submit"
                        class="btn btn-primary mt-3 rounded w-100 btn-lg"><?php echo e(get_phrase('Publish')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\demo_sociopro1.6\resources\views/frontend/main_content/create_post_modal.blade.php ENDPATH**/ ?>