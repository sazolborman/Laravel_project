        ...
        <div class="modal-content px-3">
            ...
            <div class="modal-body">
                ...
                <?php if(isset($payment_configured)): ?>
                    <form action="<?php echo e(route('creator.payout.request')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\demo\sociopro\resources\views/frontend/paid_content/payout_request.blade.php ENDPATH**/ ?>