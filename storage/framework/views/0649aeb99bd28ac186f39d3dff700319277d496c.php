<script>
    ...
    function searchUserForInviting(e, showOn){
        ...
        timer = setTimeout(function () {
            $.ajax({
				type: 'get',
				url: '<?php echo e(url("/search_user_for_event_inviting")); ?>',
				headers: {
...
<?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/frontend/events/script.blade.php ENDPATH**/ ?>