    ...
    <div class="entry-inner">
        ...
        <?php if(Route::currentRouteName() == 'timeline'): ?>
            <div class="post-options justify-content-center">
                <button class="btn" data-bs-toggle="modal" data-bs-target="#createPost"><img
                ...
                <button class="btn" data-bs-toggle="modal" data-bs-target="#createPost"><img
                        ...
                        alt="photo"><?php echo e(get_phrase('More')); ?></button>
            </div>
        <?php endif; ?>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\demo\sociopro\demo_sociopro1.6\resources\views/frontend/main_content/create_post.blade.php ENDPATH**/ ?>