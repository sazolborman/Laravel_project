        ...
        <div class="col-12">
          ...
          >
            <div class="d-flex flex-column">
              <h4><?php echo e(get_phrase('Edit your Ad')); ?></h4>
            </div>
      ...
      <div class="col-6">
        <div class="eSection-wrap-2">
          <div class="eForm-layouts">
            ...
            <form method="POST" action="<?php echo e(route('user.ad.update', $ad->id)); ?>" enctype="multipart/form-data">
              <?php if($errors->any()): ?>
              ...
              <?php endif; ?>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control eForm-control" value="<?php echo e($ad->name); ?>" id="name" name="name" placeholder="Title" required>
                </div>
                <div class="mb-3">
                  <label for="ext_url" class="form-label eForm-label"><?php echo e(get_phrase('URL')); ?></label>
                  <input type="url" class="form-control eForm-control" value="<?php echo e($ad->ext_url); ?>" id="ext_url" name="ext_url" placeholder="URL">
                </div>
                <div class="mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control eForm-control content" placeholder="Description"><?php echo e($ad->description); ?></textarea>
                </div>
...
<?php /**PATH /home/creati65/demo.creativeitem.com/sociopro/resources/views/backend/user/ad_edit.blade.php ENDPATH**/ ?>