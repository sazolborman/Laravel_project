...
Route::controller(UserController::class)->middleware('fileUploadDisabled', 'auth', 'user', 'verified', 'activity', 'prevent-back-history')->group(function () {
...
Route::controller(PaymentHistory::class)->middleware('fileUploadDisabled', 'auth', 'user', 'verified', 'activity', 'prevent-back-history')->group(function () {
