            ...
            <div class="modal-content">
                ...
                <div class="modal-footer text-center justify-content-center p-3">
                    ...
                    <button type="button" onclick="loadMaps('map')" data-tab="tab-location"
                        class="btn btn-secondary"><img src="{{ asset('storage/images/location.png') }}"
                            alt="photo">{{ get_phrase('Location') }}</button>
                    ...
                    <button type="submit"
                        class="btn btn-primary mt-3 rounded w-100 btn-lg">{{ get_phrase('Publish') }}</button>
                </div>
            </div>
        </div>
    </div>
