<!-- Single Blog Card -->
@foreach ($campaign_by_category as $row)
    @php
                ...
                <div class="card-body">
                    ...
                    @else
                        <a href="javascript:void(0)" class=" custom-btn-2 btn"
                            onclick="showCustomModal('{{ route('fundraiser.share', ['view_path' => 'frontend.main_content.share_post_modal', 'id' => $id]) }}', '{{ get_phrase('Share Campaign') }}');"><img
                                src="{{ asset('assets/frontend/css/fundraiser/images/fundraiser/share.svg') }}"
                                alt="">
                            {{ get_phrase('Share') }}
                        </a>
