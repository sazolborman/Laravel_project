...
Route::controller(SponsorController::class)->group(function () {
    ...
    // admin ad active and deactivate
    Route::get('admin/sponsor/ad/{type}/{id}', 'ad_status')->name('admin.ad.status');
});
...
Route::controller(PaidContent::class)->middleware('auth', 'verified', 'activity', 'prevent-back-history')->group(function () {
    ...
    // main addon layout
    Route::get('/addon/manager', 'addon_manager')->name('addon.manager');

    Route::get('/addon/manager/creator/payout', 'creator_payout')->name('creator.payout');
    ...
    // package
    Route::get('/paid/content/package', 'package')->name('package');
    ...
    Route::get('/paid/content/search/subscribers', 'search_subscribers')->name('search.subscribers');
    ...
    Route::post('/update/{id}', 'update_settings')->name('update');
    ...
    Route::post('/post/select/activity', 'select_activity')->name('select.activity');
    ...
    Route::get('/admin/author/status/{id}/{status}', 'author_status')->name('author.status');
    ...
    // view post by audience
    Route::get('/paid/content/view/post/audience/{type}', 'view_post_audience')->name('view.post.audience');
});
