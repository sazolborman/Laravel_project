...
<aside class="sidebar plain-sidebar">
    <div class="widget intro-widget">
        ...
        @if (isset($type) && $type == 'my_account')
            <button onclick="toggleBio(this, '.edit-bio-form')"
                class="edit-bio-btn btn btn-primary w-100">{{ get_phrase('Edit Bio') }}</button>
        @endif
    ...
    <div class="widget">
        ...
        <a href="{{ route('profile.photos') }}"
            class="btn btn-secondary mt-3 d-block mx-auto">{{ get_phrase('See More') }}</a>
    </div>
    <!--  Widget End -->
    <div class="widget friend-widget">
        ...
        <a href="{{ route('profile.friends') }}"
            class="btn btn-secondary mt-3 d-block mx-auto">{{ get_phrase('See All') }}</a
